...
A mobile-friendly pixel football game inspired by classic arcade football, now with a zoomed-in camera and larger scrolling field. Built with HTML canvas and designed for GitHub Pages.
...
- Control switches automatically to the ball carrier after a catch or handoff.
- Use the left joystick to move the current ball carrier.
...
- Buttons: **Snap**, **Throw**, **Run**, **Sprint**, **1–5 pass targets**
...
- D = debug overlay (coverage lines/zones)

## Game Rules
- Offense-only drives with downs, distance, and a running clock.
- Score touchdowns by reaching the opponent goal line.
